class PaymentService
  ...
  def pay
    ...
    if parent.present? && self.challenge_completed?(parent)
      self.purchase
    end
  end
  ...
  def challenge_completed?(donation)
    donation.children.count == 3 && self.can_still_complete?(donation)
  end

  def can_still_complete?(donation)
